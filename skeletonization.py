...
#p =  [[[[73.686157, 508.7092], [73.686157, 508.7092], [73.686157, 508.7092]], [[102.11625, 508.7092], [102.11625, 508.7092], [102.11625, 508.7092]], [[102.11625, 577.75371], [102.11625, 577.75371], [102.11625, 577.75371]], [[73.686157, 577.75371], [73.686157, 577.75371], [73.686157, 577.75371]], [[73.686157, 508.7092], [73.686157, 508.7092], [73.686157, 508.7092]]]]
...
#print(AbsPath(Regularization(Skeletonization(termNode(getPoints(p[0])),getLines(getPoints(p[0])),concaveNodes(getBypassPoints(getLines(getPoints(p[0]))))), termNodes(getBypassPoints(getLines(getPoints(p[0]))), concaveNodes(getBypassPoints(getLines(getPoints(p[0]))))), 25 )))
